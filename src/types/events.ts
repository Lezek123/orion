...
export class ContentAuctionBidMadeEvent {
    ...
    get asV3(): [bigint, bigint, bigint, (bigint | undefined)] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentAuctionCanceledEvent {
    ...
    get asV3(): [v3.ContentActor, bigint] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentBidMadeCompletingAuctionEvent {
    ...
    get asV3(): [bigint, bigint, (bigint | undefined)] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentBuyNowCanceledEvent {
    ...
    get asV3(): [bigint, v3.ContentActor] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentBuyNowPriceUpdatedEvent {
    ...
    get asV3(): [bigint, v3.ContentActor, bigint] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelAgentRemarkedEvent {
    ...
    get asV3(): [v3.ContentActor, bigint, Uint8Array] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelFundsWithdrawnEvent {
    ...
    get asV3(): [v3.ContentActor, bigint, bigint, v3.ChannelFundsDestination] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelPayoutsUpdatedEvent {
    ...
    get asV3(): [v3.UpdateChannelPayoutsParametersRecord, (bigint | undefined)] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelUpdatedEvent {
    ...
    get asV3(): [v3.ContentActor, bigint, v3.ChannelUpdateParametersRecord, bigint[]] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentChannelVisibilitySetByModeratorEvent {
    ...
    get asV3(): [v3.ContentActor, bigint, boolean, Uint8Array] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentEnglishAuctionSettledEvent {
    ...
    get asV3(): [bigint, Uint8Array, bigint] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentEnglishAuctionStartedEvent {
    ...
    get asV3(): [v3.ContentActor, bigint, v3.EnglishAuctionParamsRecord] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentNftIssuedEvent {
    ...
    get asV3(): [v3.ContentActor, bigint, v3.NftIssuanceParametersRecord] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentOfferStartedEvent {
    ...
    get asV3(): [bigint, v3.ContentActor, bigint, (bigint | undefined)] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentOpenAuctionBidAcceptedEvent {
    ...
    get asV3(): [v3.ContentActor, bigint, bigint, bigint] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentOpenAuctionStartedEvent {
    ...
    get asV3(): [v3.ContentActor, bigint, v3.OpenAuctionParamsRecord, bigint] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ContentVideoUpdatedEvent {
    ...
    get asV3(): [v3.ContentActor, bigint, v3.VideoUpdateParametersRecord, bigint[]] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMemberAccountsUpdatedEvent {
    ...
    get asV3(): [bigint, (Uint8Array | undefined), (Uint8Array | undefined)] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMemberCreatedEvent {
    ...
    get asV3(): [bigint, v3.CreateMemberParameters, number] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMemberInvitedEvent {
    ...
    get asV3(): [bigint, v3.InviteMembershipParameters] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMembershipBoughtEvent {
    ...
    get asV3(): [bigint, v3.BuyMembershipParameters, number] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class MembersMembershipGiftedEvent {
    ...
    get asV3(): [bigint, v3.GiftMembershipParameters] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDataObjectsDeletedEvent {
     ...
     * - data object IDs
     */
    get asV3(): [Uint8Array, v3.BagIdType, bigint[]] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDataObjectsMovedEvent {
     ...
     * - data object IDs
     */
    get asV3(): [v3.BagIdType, v3.BagIdType, bigint[]] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDataObjectsUpdatedEvent {
     ...
     * - Ids of the removed objects
     */
    get asV3(): [v3.UploadParametersRecord, bigint[], bigint[]] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDataObjectsUploadedEvent {
     ...
     * - state bloat bond for objects
     */
    get asV3(): [bigint[], v3.UploadParametersRecord, bigint] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketCreatedEvent {
     ...
     * - distribution bucket ID
     */
    get asV3(): [bigint, boolean, v3.DistributionBucketIdRecord] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketDeletedEvent {
     ...
     * - distribution bucket ID
     */
    get asV3(): v3.DistributionBucketIdRecord {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketInvitationAcceptedEvent {
     ...
     * - distribution bucket ID
     */
    get asV3(): [bigint, v3.DistributionBucketIdRecord] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketInvitationCancelledEvent {
     ...
     * - operator worker ID
     */
    get asV3(): [v3.DistributionBucketIdRecord, bigint] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketMetadataSetEvent {
     ...
     * - metadata
     */
    get asV3(): [bigint, v3.DistributionBucketIdRecord, Uint8Array] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketModeUpdatedEvent {
     ...
     * - distributing
     */
    get asV3(): [v3.DistributionBucketIdRecord, boolean] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDistributionBucketsUpdatedForBagEvent {
     ...
     * - storage buckets to remove ID collection
     */
    get asV3(): [v3.BagIdType, bigint, bigint[], bigint[]] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageDynamicBagCreatedEvent {
     ...
     * - uploaded data objects ids
     */
    get asV3(): [v3.DynBagCreationParametersRecord, bigint[]] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StoragePendingDataObjectsAcceptedEvent {
     ...
     * - pending data objects
     */
    get asV3(): [bigint, bigint, v3.BagIdType, bigint[]] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageStorageBucketCreatedEvent {
     ...
     * - objects limit for voucher,
     */
    get asV3(): [bigint, (bigint | undefined), boolean, bigint, bigint] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageStorageBucketInvitationAcceptedEvent {
     ...
     * - transactor account ID
     */
    get asV3(): [bigint, bigint, Uint8Array] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StorageStorageBucketsUpdatedForBagEvent {
     ...
     * - storage buckets to remove ID collection
     */
    get asV3(): [v3.BagIdType, bigint[], bigint[]] {
        assert(this.isV3)
        return this._chain.decodeEvent(this.event)
    }
}
